...
- [x] 4.2 实现磁盘写入量统计功能
- [x] 4.3 添加写入速率计算（KB/s）
- [x] 4.4 实现写入量警告功能（超过 80 KB/s）
- [x] 4.5 实现写入量限制功能（超过 100 KB/s 自动调整）
- [x] 4.6 添加性能监控日志
- [x] 4.7 在设置界面添加性能统计面板
- [x] 4.8 显示索引大小、WAL 大小、checkpoint 次数等信息
- [x] 4.9 显示健康度评分和优化建议
...
- [x] 6.1 单元测试：剪贴板防抖动机制
- [x] 6.2 单元测试：WAL checkpoint 优化
- [x] 6.3 单元测试：FSEvents 批量处理
